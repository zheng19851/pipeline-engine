package com.runssnail.pipeline.api.concurrent;
...
public class DefaultExecutorFactory implements ExecutorFactory {
    ...
    public ExecutorService create(int corePoolSize, int maxPoolSize, String queue, int queueSize, String threadNamePrefix) {
        ...
        ThreadPoolExecutor executor = new ThreadPoolExecutor(corePoolSize, maxPoolSize, Constants.DEFAULT_KEEP_ALIVE_TIME,
